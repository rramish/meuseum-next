export const ICONS = {
  ...
  logout_icon: new URL("./logout.svg", import.meta.url).href,
  back_icon: new URL("./back_arrow.svg", import.meta.url).href,
  dell_icon: new URL("./dell_icon.png", import.meta.url).href,
  zoom_2x_icon: new URL("./zoom-2x-icon.svg", import.meta.url).href,
  zoom_1x_icon: new URL("./zoom-1x-icon.svg", import.meta.url).href,
  reload_icon: new URL("./reload.svg", import.meta.url).href,
